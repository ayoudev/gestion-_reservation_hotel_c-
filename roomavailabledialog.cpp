...
void RoomAvailableDialog::readData()
{
    ...
    ui->lblinfo->setStyleSheet("QLabel { background-color : grey; color : #008d36; }");
    ...
    for(std::vector<int>::iterator it = temprooms.begin(); it!=temprooms.end(); it++ )
    {
        ...
        if(ptr)
        {
            ptr->setStyleSheet("QLabel { background-color : lightgrey; color : #008d36; }");
        }
    ...
    for(std::vector<int>::iterator it = rooms.begin(); it!=rooms.end(); it++ )
    {
        ...
        if(ptr)
        {
            ...
            ptr->setStyleSheet("QLabel { background-color : grey; color : #008d36; }");
        }
